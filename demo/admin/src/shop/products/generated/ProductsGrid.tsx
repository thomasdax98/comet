...
export function ProductsGrid(): React.ReactElement {
    ...
    const columns: GridColDef<GQLProductsListFragment>[] = [
        ...
        { field: "price", headerName: intl.formatMessage({ id: "product.price", defaultMessage: "Price" }), type: "number", width: 150 },
        {
            ...
            type: "singleSelect",
            valueOptions: [
                { value: "Laptop", label: intl.formatMessage({ id: "product.type.laptop", defaultMessage: "Laptop" }) },
                { value: "Smartphone", label: intl.formatMessage({ id: "product.type.smartphone", defaultMessage: "Smartphone" }) },
                { value: "Smartwatch", label: intl.formatMessage({ id: "product.type.smartwatch", defaultMessage: "Smartwatch" }) },
            ],
            width: 150,
        },
        {
