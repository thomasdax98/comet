                            ...
                            {(props) => (
                                <FinalFormSelect {...props}>
                                    <MenuItem value="Laptop">
                                        <FormattedMessage id="product.type.laptop" defaultMessage="Laptop" />
                                    </MenuItem>
                                    <MenuItem value="Smartphone">
                                        <FormattedMessage id="product.type.smartphone" defaultMessage="Smartphone" />
                                    </MenuItem>
                                    <MenuItem value="Smartwatch">
                                        <FormattedMessage id="product.type.smartwatch" defaultMessage="Smartwatch" />
                                    </MenuItem>
                                </FinalFormSelect>
                            )}
                        </Field>
