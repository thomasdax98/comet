...
export function createDamFileDownloadLinkBlock(options?: DamFileDownloadLinkBlockOptions) {
    const DamFileDownloadLinkBlock: BlockInterface<DamFileDownloadLinkBlockData, DamFileDownloadLinkBlockData, DamFileDownloadLinkBlockInput> = {
        ...
        displayName: <FormattedMessage id="seat.blocks.damFileDownloadLink" defaultMessage="CMS Asset" />,
                    ...
                    >
                        {state.file !== undefined ? (
                            <AdminComponentPaper disablePadding>
                                ...
                                >
                                    <FormattedMessage id="seat.generic.empty" defaultMessage="Empty" />
                                </AdminComponentButton>
                            </AdminComponentPaper>
                        ) : (
                        ...
                        <AdminComponentPaper>
                            <Field
                                name="openFileType"
                                fullWidth
                                label={<FormattedMessage id="seat.blocks.damFileDownloadLink.openFileType" defaultMessage="Open File Type" />}
                            >
                                {(props) => (
                                    <>
                        ...
                        <AdminComponentPaper>
                            <AdminComponentSection
                                title={
                                    <FormattedMessage id="seat.blocks.damFileDownloadLink.tracking" defaultMessage="Data-Attributes for Tracking" />
                                }
                            >
                                <Field
                                    ...
                                    label={
                                        <FormattedMessage
                                            id="seat.blocks.damFileDownloadLink.tracking.gtmElementType"
                                ...
                                <Field
                                    ...
                                    label={
                                        <FormattedMessage
                                            id="seat.blocks.damFileDownloadLink.tracking.gtmElementName"
...
const openFileTypeOptions = [
    {
        ...
        name: <FormattedMessage id="seat.blocks.damFileDownloadLink.openFileType.download" defaultMessage="Download" />,
    },
    {
        value: OpenFileTypeMethod.NEW_TAB,
        name: <FormattedMessage id="seat.blocks.damFileDownloadLink.openFileType.newTab" defaultMessage="Open in a new tab" />,
    },
];
