...
export function createPageTreeResolver({
    PageTreeNode,
    PageTreeNodeCreateInput: PassedPageTreeNodeCreateInput,
    PageTreeNodeUpdateInput: PassedPageTreeNodeUpdateInput,
    Documents,
    Scope: PassedScope,
    Category,
}: {
    ...
    const PageTreeNodeCreateInput = PassedPageTreeNodeCreateInput || DefaultPageTreeNodeCreateInput;
    const PageTreeNodeUpdateInput = PassedPageTreeNodeUpdateInput || DefaultPageTreeNodeUpdateInput;
